...
module gameLogic{
	'use strict';
  	...
  	export function canSowOpponent(board : any, row : any, col : any) {
  		return (board[row][col]) > (row === 0 ? col : 5 - col);
  	}

    export function hasHousesThatCanSowOpponent(board : any, turnIndex : any) {
        for(var i = 0; i < 6; i++) {
  	...
  	export function getSeedsInRow(board : any, rowIndex : any) {
  		var seeds = 0;
  		for(var i = 0; i < 6; i++) {
  	...
  	export function getWinner(board : any, scores : any) {
   	...
   	export function isTie(scores : any) {
    ...
    */
    export function getPossibleMoves(board : any, turnIndex : any, scores : any) {
    ...
    */
    export function createMove(board : any, row : any, col : any, turnIndexBeforeMove : any, scores : any) {
